# 2e4c5eae-5a8b-46ae-97db-151a4dea8997 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `admin-dashboard.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `admin-dashboard.html`
...
- A single self-contained `admin-dashboard.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `admin-dashboard.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `luxury-gym-landing.html`

## Styles
- `noir/public/admin.css`

## Scripts/components
- `noir/server/auth.js`
- `noir/server/db.js`
- `noir/server/index.js`
- `noir/server/markdown.js`
- `noir/server/routes/admin.js`
- `noir/server/routes/public.js`
- `noir/server/seed.js`
- `noir/server/smoke-test.js`

## Assets and supporting files
- `admin-dashboard-plan.md`
- `assets/club-room.jpg`
- `assets/coach-david.jpg`
- `assets/coach-elena.jpg`
- `assets/coach-marcus.jpg`
- `assets/hero-gym.jpg`
- `luxury-gym-landing.md`
- `noir/noir.db`
- `noir/package-lock.json`
- `noir/package.json`
- `noir/server/schema.sql`
- `noir/views/blog-editor.ejs`
- `noir/views/blog.ejs`
- `noir/views/dashboard.ejs`
- `noir/views/leads.ejs`
- `noir/views/login.ejs`
- `noir/views/members.ejs`
- `noir/views/partials/foot.ejs`
- `noir/views/partials/head.ejs`
- `noir/views/partials/rail.ejs`
- `noir/views/settings.ejs`
- `noir/views/tiers.ejs`
- `Screenshot-2026-08-09-at-8.26.26-AM.png`
- `Screenshot-2026-08-09-at-8.26.39-AM.png`

## Coding checklist for AI tools
1. Inspect `admin-dashboard.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
